    ...
    <div class="voitures-list">
        ...
        <div class="voiture-row">
            ...
            <div class="voiture-actions">
                <a href="ModifyCar.php?id=<?php echo $card['id'] ?>" class="btn-modifier">
                    ✏️ Modifier
                </a>
                <form method="post" action="DeleteCar.php" style="margin:0">
...
<section id="concessionaire-section" style="display:none;">
    <?php require 'QweryMyDealership.php'; 
    $_SESSION['dealer_id'] = $concess['id'] ?? null;
    ?>
    ...
    <form id="formConcessionaire" method="post" action="UpdateConcessionnaire.php"
        ...
        <div class="cs-row">
            ...
            <div class="cs-row-right">
                <div class="cs-banner-preview" id="bannerPreview">
                    <?php if (!empty($concess['photo_banniere'])): ?>
                        <img src="<?php echo htmlspecialchars($concess['photo_banniere']) ?>" alt="Bannière">
                    <?php else: ?>
                        <div class="cs-banner-placeholder">🖼️<br>Aucune bannière</div>
                    <?php endif; ?>
                </div>
                <input type="hidden" name="banner_current"
                       value="<?php echo htmlspecialchars($concess['photo_banniere'] ?? '') ?>">
                ...
                <div class="cs-links-list">
                    ...
                    <div class="cs-link-item" id="linkItem1">
                        <input type="url" name="lien1" class="cs-input"
                               value="<?php echo htmlspecialchars($concess['site_web'] ?? '') ?>"
        ...
        <div class="cs-row">
            ...
            <div class="cs-row-right" style="display:flex; flex-direction:column; gap:12px;">
                ...
                <input type="text" name="localisation" class="cs-input"
                       value="<?php echo htmlspecialchars($concess['adresse'] ?? '')?>"
