...
document.addEventListener("DOMContentLoaded", () => {
    // Si la marque est déjà remplie (par PHP lors de l'édition), on charge les modèles
    if (input.value) {
        fetchito(input.value);
    }
    // Si la version/modèle est également définie, on pourrait aussi forcer otroFetch mais ce n'est pas strictement nécessaire pour soumettre.
    ...
    fileInputs.forEach((input) => {
        input.addEventListener("change", function () {
            ...
            // Retirer l'ancien contenu vide s'il y est
            const emptyContent = previewContainer.querySelector(".photo-empty");
